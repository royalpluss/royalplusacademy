...
const teachers = [
  ...
  {
    name: "دعاء عبد الحميد",
    subjects: "بكالوريوس علوم وتربيه قسم رياضيات",
    stages: "معلمة مادة رياضيات للمرحلة الإعدادىة والثانوية ",
  },
  {
    name: "أحمد السيد",
    subjects: " بكالوريوس علوم وتربيه قسم رياضيات ومعلم الرياضيات بمدرسة الثانوية بنين",
    stages: "معلم مادة رياضيات للمرحلة الإعدادىة والثانوية ",
  },
  {
    name: "عادل ماهر",
